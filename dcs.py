...
class CodeDataClass:
    ...
    def __init__(self):
        ...
        self.data = config.retrieve_data(source="data/new_codes.csv", dtype=config.code_data(), ext="csv")
...
class SensorDetails:
    ...
    def __init__(self):
        self.label = "Code attributes"
        self.data = config.retrieve_data(source="data/dc_locations.csv", dtype=config.sensor_columns(), ext="csv")
...
def create_survey_db(connection: str = None):
    ...
    if connection is None:
        with open("data/dc_surveys.csv", "r") as a_file:
